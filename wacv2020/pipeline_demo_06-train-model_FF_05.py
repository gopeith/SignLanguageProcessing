...
fname_example = "temp/demo/%s-example.txt" % model_ID

list_training = loadList("data/demo/lists/train.list")
list_stop = loadList("data/demo/lists/test.list")


n_files_in_batch = len(list_training)
...
# when stop training
max_steps = 100 * len(list_training)
